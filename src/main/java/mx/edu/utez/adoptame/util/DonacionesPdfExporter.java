...
public class DonacionesPdfExporter {

    private Logger logger = LoggerFactory.getLogger(DonacionesPdfExporter.class);

    private List<Donacion> listDonaciones;

    public DonacionesPdfExporter(List<Donacion> listDonaciones) {
    ...
    private void writeTableData(PdfPTable table) {
        for (Donacion donacion : listDonaciones) {
            table.addCell("$ " + donacion.getMonto());
